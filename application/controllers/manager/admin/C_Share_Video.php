...
class C_Share_Video extends CI_Controller {
	...
	public function index(){
		if(!isset($_SESSION['username'])){
			...
			header("Location: ".base_url()."index.php/manager/admin/view/sharelink");
		}
	}
	...
	public function getAllLinkVideo(){
		...
		$this->load->View('manager/admin/sharevideo_view.php', $data);
	}
	...
	public function getAllLinkVideoUnAgreed(){
		...
		$data['listlink'] = array('link' => $link);
		$this->load->View('manager/admin/videoUnApproval_view.php', $data);
	}
