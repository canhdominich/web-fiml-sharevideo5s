...
class C_Admin_Video extends CI_Controller {
    ...
    if(isset($_SESSION['username'])){
      ...
      if(isset($_SESSION['username'][0]['user_id'])){
        $video = $this->M_Video->getAllVideoByUserId($_SESSION['username'][0]['user_id']);
    ...
    // $this->load->view('manager/header_view');
      $this->load->View('manager/video_view.php', $data);
  ...
  public function insertVideo(){
    ...
    if(isset($_SESSION['username'])){
      ...
      if($flag){
       header("location:".base_url()."index.php/manager/C_Admin_Video");
     }
     else{
  			// message
     }
  ...
  $response_a = json_decode($response);
    ...
    // Ham convert video duration
     ...
     public function getVideoById($video_id){
       ...
       $this->load->View('manager/updatevideo_view.php', $data);
     }
...
// close cURL resource, and free up system resources
  ...
  public function updateVideo($video_id){
  	...
  	if($flag){
  		header("location:".base_url()."index.php/manager/system");
  	}
  	else{
			// message
  	}
