 <!DOCTYPE html>
 <html lang="en"><head>
 	<title>Manager Link Video</title>
 	<meta charset="utf-8">
 					...
 					<div class="col-sm-4">
 						<div class="card">
 							<div class="card-body">
 								...
 								if($video['status'] == 0){
 									?>
 									<p class="card-text editns"><small><a href="<?php echo base_url(); ?>index.php/C_ShareVideo/videoApproval/<?php echo $video['video_id']; ?>" class="btn btn-warning btn-xs">Đồng ý</a></small></p>
 									<?php
 								}
 								?>

 								<p class="card-text editns"><small><a id="delete" onclick="return confirm('Bạn chắc chắn xóa?');" href="<?php echo base_url(); ?>index.php/C_ShareVideo/deleteLinkVideoById/<?php echo $video['video_id']; ?>" class="btn btn-outline-danger btn-xs">Loại bỏ</a></small></p>
 							</div>
 						</div><br/>
 					</div>
 					<?php } ?>
