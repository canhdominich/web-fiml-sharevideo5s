 					...
 					<div class="col-sm-4">
 						<div class="card">
 							<div class="card-body">
 								...
 								if($video['status'] == 1){
 									?>
 									<p class="card-text editns"><small><a href="<?php echo base_url(); ?>index.php/manager/admin/view/uploadVideo/<?php echo $video['video_id']; ?>" class="btn btn-warning btn-xs">Upload server</a></small></p>
 									<?php
 								}
 								?>
