 		...
 		<div id="page-content-wrapper">
 			<div class="container-fluid">
 				<div class="justify-content-center">
 					<h3>Download Image</h3><hr>
 					<form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/manager/C_Download_Image/downloadImage">
 						<div class="row">
 							<div class="col-sm-6">
 							...
 							<div class="col-sm-6">
 								<div class="form-group">
 									<label for="ten"><strong>Nơi lưu trữ</strong></label>
 									<input type="text" name="save" class="form-control" id="ten" placeholder="Ex: D:/xampp/htdocs/Project-Educations/images/" value="D:/xampp/htdocs/Project-Educations/images/">
 								</div>
 							</div>
 						</div>
