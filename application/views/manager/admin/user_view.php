	...
	<div id="page-content-wrapper">
		<div class="container-fluid">
			<div class="justify-content-center">
				...
				<form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/manager/C_Admin_Video/insertVideo">
					<div class="row">
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="title" class="form-control" id="ten" placeholder="Ex: Đạo đức con người là cực kỳ quan trọng">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
			...
			<div class="card-deck">
				<?php foreach ($listallvideo['allvideo'] as $video){ ?>
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body">
								<img  style="height: 250px" class="card-img-top img-fluid img-thumbnail" src="<?php echo base_url(); ?>images/<?php echo $video['image']; ?>" alt="" >
								<br/>
								<br/>
								<h6 class="card-title" style="color: red;"><?php echo substr($video['title'], 0, 100)."..."; ?></h4>
									...
									<p class="card-text editns"><small><a href="<?php echo base_url(); ?>index.php/manager/C_Admin_Video/getVideoById/<?php echo $video['video_id']; ?>" class="btn btn-warning btn-xs">Sửa nội dung</a></small></p>

									<p class="card-text editns"><small><a id="delete" onclick="return confirm('Bạn chắc chắn xóa?');" href="<?php echo base_url(); ?>index.php/manager/C_Admin_Video/deleteVideo/<?php echo $video['video_id']; ?>" class="btn btn-outline-danger btn-xs">Xóa nội dung</a></small></p>
								</div>
							</div><br/>
						</div>
					<?php } ?>
