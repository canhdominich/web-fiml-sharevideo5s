 <div id="wp-list-post" class="clearfix">
 	<ul>
 		<?php foreach ($listvideobyrequest['videobyrequest'] as $video) {
							# code...
 			?>
 			<li>
 					...
 					<div>
 						...
 						<div class="category-list-post-detail fl-right">
 							...
 							<div class="list-post-video-title text-justify">
 								<br/>
 								<span><?php echo $video['date']; ?> || <a href="<?php echo base_url(); ?>index.php/video/author/<?php echo str_replace(" ", "-", $video['author']); ?>"  class="author"><?php echo $video['author']; ?></a></span><br/> 
